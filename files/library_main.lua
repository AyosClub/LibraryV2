...
do
    ...
    function Funcs:AddColorPicker(Idx, Info)
        ...
        local CheckerFrame = Library:Create('ImageLabel', {
            ...
            ZIndex = 5;
            Image = getcustomasset'omen.vip/files/12977615774.png';
        ...
        local SatVibMap = Library:Create('ImageLabel', {
            ...
            Size = UDim2.new(1, 0, 1, 0);
            ZIndex = 18;
            Image = getcustomasset'omen.vip/files/4155801252.png';
        ...
        local CursorOuter = Library:Create('ImageLabel', {
            ...
            BackgroundTransparency = 1;
            Image = getcustomasset'omen.vip/files/9619665977.png';
        ...
        if Info.Transparency then 
            ...
            Library:Create('ImageLabel', {
                BackgroundTransparency = 1;
                Size = UDim2.new(1, 0, 1, 0);
                Image = getcustomasset'omen.vip/files/12978095818.png';
                ZIndex = 20;
...
do
    ...
    function Funcs:AddDropdown(Idx, Info)
        ...
        local DropdownArrow = Library:Create('ImageLabel', {
            ...
            Image = getcustomasset'omen.vip/files/6282522798.png';
            ZIndex = 8;
            Parent = DropdownInner;
        });
